...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002384366779"))
...
BIN_CHANNEL = int(os.getenv('BIN_CHANNEL', '-1002323592481'))  #Need to put same id of stream bot log channel
